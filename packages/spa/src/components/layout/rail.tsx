 ...
 * tab strip's inside its own — with a 28px button in it, the square the project
 * chip beside it and the tabs above it are.
 *
 ...
 * against it rather than a seam away from it — see `app-rail`. Nothing is drawn
 * where the two meet, so the 4px between the icons and that join is the same
 * 4px as between the join and the first chip on the other side of it.
 */
...
export function Rail({
  ...
  return (
    <nav
      aria-label={label}
      className="app-rail relative flex h-full w-9 shrink-0 flex-col items-center py-1"
    >
